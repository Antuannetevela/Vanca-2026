...
function actualizarTotalCorto() {
  ...
  let total = perros + gatos;
  // El total es perros + gatos, pero se guarda como total_perros para compatibilidad
  document.getElementById('total_perros').value = total;
  document.getElementById('total_animales_corto').value = total;
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('formulario').addEventListener('submit', async function (e) {
    ...
    const microred = document.getElementById('microred').value.trim();
    const fechaBarrio = document.getElementById('fecha_barrio').value.trim();

    if (!microred) {
      alert("Debe seleccionar una microred.");
      return;
    }
    ...
    try {
      ...
      if (json.success) {
        ...
        document.getElementById('total_animales_corto').value = '0';
